...
echo "[3] Deploying to AWS Lambda [tunema-soundFunction]..."
aws lambda update-function-code --function-name tunema-soundFunction --zip-file fileb://build/$build_name.zip
